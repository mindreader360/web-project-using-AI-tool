...
var Menu = createLucideIcon("menu", __iconNode2);
...
var ShoppingBag = createLucideIcon("shopping-bag", __iconNode4);
...
var CartContext = (0, import_react3.createContext)(void 0);
function useCart() {
  const context = (0, import_react3.useContext)(CartContext);
  if (context === void 0) {
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  const size = (0, import_react9.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0,
  ...
  const { nonce } = (0, import_react9.useContext)(MotionConfigContext);
  ...
  return (0, import_jsx_runtime2.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, pop, children: pop === false ? children : React14.cloneElement(children, { ref: composedRef }) });
}
...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  const isPresentRef = (0, import_react10.useRef)(isPresent);
  const onExitCompleteRef = (0, import_react10.useRef)(onExitComplete);
  useIsomorphicLayoutEffect2(() => {
    isPresentRef.current = isPresent;
    onExitCompleteRef.current = onExitComplete;
  });
  let isReusedContext = true;
  let context = (0, import_react10.useMemo)(() => {
  ...
  children = (0, import_jsx_runtime3.jsx)(PopChild, { pop: mode === "popLayout", isPresent, anchorX, anchorY, root, children });
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  const exitingComponents = (0, import_react13.useRef)(/* @__PURE__ */ new Set());
  ...
  return (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime4.jsx)(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, anchorY, children: child }, key);
  }) });
};
...
var MotionContext = /* @__PURE__ */ (0, import_react15.createContext)({});
...
function useSVGProps(props, visualState, _isStatic, Component6) {
  const visualProps = (0, import_react18.useMemo)(() => {
    ...
    buildSVGAttrs(state, visualState, isSVGTag(Component6), props.transformTemplate, props.style);
    return {
      ...state.attrs,
      style: { ...state.style }
    };
...
// node_modules/framer-motion/dist/es/render/dom/use-render.mjs
function useRender(Component6, props, ref, { latestValues }, isStatic, forwardMotionProps = false, isSVG) {
  const useVisualProps = isSVG ?? isSVGComponent(Component6) ? useSVGProps : useHTMLProps;
  ...
  const elementProps = Component6 !== import_react19.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
  const { children } = props;
  const renderedChildren = (0, import_react19.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
  return (0, import_react19.createElement)(Component6, {
    ...elementProps,
...
// node_modules/framer-motion/dist/es/motion/utils/use-visual-element.mjs
function useVisualElement(Component6, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  ...
  const wantsHandoff = (0, import_react23.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !window.MotionHandoffIsComplete?.(optimisedAppearId) && window.MotionHasOptimisedAnimation?.(optimisedAppearId));
  useIsomorphicLayoutEffect2(() => {
...
// node_modules/framer-motion/dist/es/motion/index.mjs
function createMotionComponent(Component6, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  preloadedFeatures && loadFeatures(preloadedFeatures);
  const isSVG = type ? type === "svg" : isSVGComponent(Component6);
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    if (!isStatic && typeof window !== "undefined") {
      ...
      context.visualElement = useVisualElement(Component6, visualState, configAndProps, createVisualElement, layoutProjection.ProjectionNode, isSVG);
    }
    return (0, import_jsx_runtime5.jsxs)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (0, import_jsx_runtime5.jsx)(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component6, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps, isSVG)] });
  }
  MotionDOMComponent.displayName = `motion.${typeof Component6 === "string" ? Component6 : `create(${Component6.displayName ?? Component6.name ?? ""})`}`;
...
function createMotionProxy(preloadedFeatures, createVisualElement) {
  ...
  const factory = (Component6, options) => {
    return createMotionComponent(Component6, options, preloadedFeatures, createVisualElement);
  };
  const deprecatedFactoryFunction = (Component6, options) => {
    if (true) {
      warnOnce(false, "motion() is deprecated. Use motion.create() instead.");
    }
    return factory(Component6, options);
  };
...
var createDomVisualElement = (Component6, options) => {
  const isSVG = options.isSVG ?? isSVGComponent(Component6);
  return isSVG ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component6 !== import_react25.Fragment
  });
};
...
var MeasureLayoutWithContext = class extends import_react26.Component {
  /**
...
function Navbar() {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = (0, import_react27.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("nav", { className: "sticky top-0 z-50 bg-[#FDF8F5]/90 backdrop-blur-md border-b border-[#EAD0D1]/50", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex justify-between items-center h-20", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex items-center md:hidden", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "button",
        {
          onClick: () => setIsMobileMenuOpen(!isMobileMenuOpen),
          className: "text-[#333333] hover:text-[#D4AF37] transition-colors",
          children: isMobileMenuOpen ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(X, { size: 24 }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Menu, { size: 24 })
        }
      ) }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex-shrink-0 flex items-center justify-center md:justify-start flex-1 md:flex-none", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Link, { to: "/", className: "font-serif text-3xl font-bold tracking-tight text-[#333333]", children: [
        "Rupat",
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[#D4AF37]", children: "." })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "hidden md:flex flex-1 justify-center items-center space-x-8", children: navLinks.map((link) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        Link,
        {
          to: link.path,
          className: `text-sm tracking-wide uppercase font-medium transition-colors hover:text-[#D4AF37] ${isActive(link.path) ? "text-[#D4AF37]" : "text-[#333333]"}`,
          children: link.name
        },
        link.name
      )) }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center space-x-4 md:space-x-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "text-[#333333] hover:text-[#D4AF37] transition-colors hidden sm:block", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Search, { size: 20 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "text-[#333333] hover:text-[#D4AF37] transition-colors hidden sm:block", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(User, { size: 20 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "text-[#333333] hover:text-[#D4AF37] transition-colors hidden sm:block", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Heart, { size: 20 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Link, { to: "/cart", className: "text-[#333333] hover:text-[#D4AF37] transition-colors relative", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ShoppingBag, { size: 20 }),
          cartCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "absolute -top-2 -right-2 bg-[#D4AF37] text-white text-[10px] font-bold h-4 w-4 rounded-full flex items-center justify-center", children: cartCount })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(AnimatePresence, { children: isMobileMenuOpen && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      motion2.div,
      {
        initial: { height: 0, opacity: 0 },
        animate: { height: "auto", opacity: 1 },
        exit: { height: 0, opacity: 0 },
        className: "md:hidden bg-[#FDF8F5] border-b border-[#EAD0D1]/50 overflow-hidden",
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "px-4 pt-2 pb-6 space-y-1 flex flex-col", children: [
          navLinks.map((link) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            Link,
            {
              to: link.path,
              onClick: () => setIsMobileMenuOpen(false),
              className: `block px-3 py-3 text-base font-medium tracking-wide uppercase ${isActive(link.path) ? "text-[#D4AF37]" : "text-[#333333]"}`,
              children: link.name
            },
            link.name
          )),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex space-x-6 px-3 pt-4 border-t border-[#EAD0D1]/50 mt-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "text-[#333333] hover:text-[#D4AF37] transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Search, { size: 20 }) }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "text-[#333333] hover:text-[#D4AF37] transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(User, { size: 20 }) }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "text-[#333333] hover:text-[#D4AF37] transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Heart, { size: 20 }) })
          ] })
        ] })
      }
    ) })
